...
- Index Controller with ![VRCThumbParamsOSC](https://github.com/I5UCC/VRCThumbParamsOSC) or ![VRCThumbParams-MOD (Deprecated)](https://github.com/I5UCC/VRC-ASL_Gestures/releases/download/v1.4/ThumbParams.dll)
- Index Controller without any mods (Left/Right Hand Dominant versions available) <br/>
***(early state / Not Recommended)***.
